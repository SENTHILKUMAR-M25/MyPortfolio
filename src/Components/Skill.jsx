...
const frontendSkills = [
  { name: "REACT / NEXT.JS", value: 95, color: "from-red-900 via-red-600 to-red-500", sub: "Hooks, SSR, Performance Architect" },
  ...
  { name: "THREE.JS / MOTION", value: 75, color: "from-zinc-900 via-red-800 to-red-700", sub: "3D Rendering, R3F, Interaction Design" },
